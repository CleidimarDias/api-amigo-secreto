...
router.get('/ping', auth.validate, (req, res)=>{
    res.json({pongAdmin: true, admin: true})
})
...
router.delete('/event/:id', auth.validate, events.deletEvent);
...
router.delete('/events/:id_event/groups/:id', auth.validate, groups.deletGroup)

router.get('/events/:id_event/groups/:id_group/people', auth.validate, people.getAll);
router.get('/events/:id_event/groups/:id_group/pelople/:id', auth.validate, people.getPerson)
router.post('/events/:id_event/groups/:id_group/people', auth.validate, people.addPerson)
router.put('/events/:id_event/groups/:id_group/people/:id', auth.validate, people. updatPerson)
